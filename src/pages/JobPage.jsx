          ...
          <div className='grid grid-cols-1 md:grid-cols-70/30 w-full gap-6'>
            ...
            <aside>
              <div className='bg-white p-6 rounded-lg shadow-md'>
                ...
                <p className='my-2 bg-indigo-100 p-2 font-bold overflow-scroll'>{job.company.contactEmail}</p>

                <h3 className='text-xl'>Contact Phone:</h3>

                <p className='my-2 bg-indigo-100 p-2 font-bold overflow-scroll'>{job.company.contactPhone}</p>
              </div>
